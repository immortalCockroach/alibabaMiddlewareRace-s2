...
public class CommonConstants {
	...
	// 买家 商品文件切割份数
	public static final int OTHER_SPLIT_SIZE = 128;
	
	// 索引文件的每行record数目 整行的大小控制在400-800byte左右 此时读取和split性能较好，预估索引文件每行的单个记录在50bytes左右
	public static final int INDEX_LINE_RECORDS = 12;
